    ...
    class Program
    {
        ...
        static List<Monster> InitializeMonsterList()
        {
            ...
            List<Monster> monsters = new List<Monster>()
            {
                ...
                new Monster()
                {
                    ...
                    Age = 400,
                    Attitude = Monster.EmotionalState.happy,
                    Tribe = Monster.Location.west
                },

                new Monster("Luke", 240, Monster.EmotionalState.angry, Monster.Location.south)
        ...
        static void DisplayMenuScreen(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                Console.WriteLine("\tf) Write Data");
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            Console.Write("\tTribe: ");
            Enum.TryParse(Console.ReadLine(), out Monster.Location tribe);
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            Console.Write($"\tCurrent Name: {selectedMonster.Tribe} New Name: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
                Enum.TryParse(userResponse, out Monster.Location tribe);
